...
<body class="w-full font-body overflow-y-scroll relative">
    ...
    <div
        class="h-full !z-50 w-screen absolute top-0 right-0 left-0 bottom-0 hidden sm:block backdrop-blur-sm bg-red-900 p-5">
        <div class="flex h-full flex-col justify-center items-center">
            <h1 class="font-bold text-3xl text-white">Mohon Maaf</h1>
            <p class="text-white text-center">web ini hanya tersedia untuk tampilan mobile</p>
        </div>
    </div>
